        ...
        return (
          <div key={product.id} className="mx-2">
            <div className="max-w-sm mx-2 h-auto  rounded overflow-hidden shadow-xl delay-100 hover:shadow-slate-500 hover:shadow-2xl transition hover:-translate-y-1">
              ...
              <img
                className="w-11/12 mx-auto  mt-2 h-32 md:h-52 "
              ...
              <div className="px-6 py-4 grid grid-row-3">
                ...
                <div className="">
                  <h1 className="text-sm md:text-md font-semibold text-green-400">
                    Rs:{priceInRs}
                  </h1>
                </div>
                <div>
                ...
                <div>
                  <h1 className="text-xs md:text-sm text-gray-700">
                    Stock:{product.stock}
                  </h1>
                </div>
                <div className=" mt-2 md:text-center w-full">
                  <button
                    ...
                    className="md:h-6 md:w-8/12 text-sm  bg-red-500 text-white rounded-lg cursor-pointer hover:bg-red-700"
                  >
                    Add to cart
                  </button>
                </div>
